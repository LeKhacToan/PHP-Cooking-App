...
<div class="main-content">
    <div class="page-header">
        ...
        <div class="page-actions">
            <a href="admin/dokho/them" class="btn btn-primary"><i class="icon-fa icon-fa-plus"></i>Thêm độ khó</a>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
                        ...
                        <tbody>
                            @foreach($dokho as $at)
                                <tr>
                                    <td>{{ $at->id }}</td>
                                    <td>{{ $at->name }}</td>
                                    <td><a href="admin/dokho/sua/{{$at->id}}" class="btn btn-default btn-sm"><i
                                        class="icon-fa icon-fa-search"></i>Edit</a>
                                      <a href="admin/dokho/xoa/{{$at->id}}" class="btn btn-default btn-sm"
