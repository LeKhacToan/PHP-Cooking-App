...
<div class="main-content">
    <div class="page-header">
        ...
        <div class="page-actions">
            <a href="admin/loaimon/them" class="btn btn-primary"><i class="icon-fa icon-fa-plus"></i>Thêm loại món</a>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
                ...
                <div class="card-body">
                    <table id="default-datatable" class="table table-striped table-bordered" style="width:100%" cellspacing="0"
                        ...
                        <tbody>
                            ...
                            @foreach($loaimon as $at)
                                <tr>
                                    <td>{{ $at->id }}</td>
                                    <td>{{ $at->name }}</td>
                                    <td><a href="admin/loaimon/sua/{{$at->id}}" class="btn btn-default btn-sm"><i
                                        class="icon-fa icon-fa-search"></i>Edit</a>
                                      <a href="admin/loaimon/xoa/{{$at->id}}" class="btn btn-default btn-sm"
